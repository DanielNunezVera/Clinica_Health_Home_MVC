...
<body>
            ...
            <div class="cover"> 
                <div class="caja1">
                    <div class="row" style="margin-top: 1.5em">
                        ...
                        <div class="lista">
                            <ul style="border: #000 1px solid;">
                                <input type="checkbox" id="pregunta1">
                                <div>
                                    <label for="pregunta1"><li><h4>¿Cómo inicio sesión?</h4></li></label>
                                </div>
                                <div class="respuesta1">
                                    <p>Para ingrear a mi cuenta debo identidicar mi rol, ya sea paciente, auxiliar, administrador o profesinal. 
    ...
    da click al voton enviar y si esta registrado y los datos son correctos ingresara a su cuenta.</p>
                                ...
                                <div>
                                    <label for="pregunta2"><li><h4>¿Cómo restablecer la contraseña?</h4></li></label>
                                </div>
                                <div class="respuesta2">
                                    <p>Se ubica en donde normalmnte inicia session, de bajo del boton "Enviar" encontrara el boton "Restablecer contraseña" da click, lo va a redirigir a una nueva ventana donde
...
de actualizar datos, una vez ubicado ahi ingresara el codigo que llego a su correo en el apartado de contraseña actual, despues podra escribir su nueva clave no menor a 8 caracteres, dara click en boton "actualizar"</p>
                                ...
                                <div>
                                    <label for="pregunta3"><li><h4>¿Cómo puedo registrarme?</h4></li></label>
                                </div>
                                <div class="respuesta3">
                                    <p>Debe comunicarse con la Clinica Health Home a traves de sus canales de atencion, ya sea por sus redes sociales, email o telefono que aparece en la parte inferior de la 
primera pagina.</p>
                                </div>
                                <input type="checkbox" id="pregunta4">
                                <div>
                                    <label for="pregunta4"><li><h4>¿Cómo agendar una cita?</h4></li></label>
                                </div>
                                <div class="respuesta4">
                                    <p>Los pacientes que quieran agendar una cita deberan iniciar session con su cuenta, una vez lo haya hecho debera ingresar agendar cita dando click al boton "Agendar cita"
