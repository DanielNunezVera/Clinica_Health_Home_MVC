...
var FullCalendar = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    function GenerateCalendar(working_days) {
        $('#calendarSchedule').fullCalendar({
           ...
           // navLinks:  true,
            ...
            selectAllow: function (select) {
                ...
                return JudgeWeekDay(select.start, working_days);
            },
            dayRender: function (date, cell) {
                if (!JudgeWeekDay(date, working_days)) {
            ...
            viewRender: function (currentView) {
                ...
                Cookies.set('fullCalendarCurrentView', currentView.name, { path: '' });
                Cookies.set('fullCalendarCurrentDate', currentView.intervalStart.format(), { path: '' });
            },
